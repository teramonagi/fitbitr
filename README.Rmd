...
### Body and Weight
```{r}
log_body_fat(token, 12.54, "2017-12-01")
log_body_fat(token, 12.54, "2017-12-02")
df <- get_body_fat_logs(token, date="2017-12-05", period="7d")
df
delete_body_fat_log(token, df$logId[1])
get_body_fat_logs(token, date="2017-12-05", period="7d")
```
