...
#' @export
get_activity_logs_list <- function(before_date, after_date, sort, offset, limit)
{
...
#'
#' Retrieves a list of a user's recent activities types logged with some details of the last activity log of that type using units in the unit system which corresponds to the Accept-Language header provided. The record retrieved can be used to log the activity via the Log Activity endpoint with the same or adjusted values for distance and duration.
#' @export
get_recent_activity_types <- function()
{
...
#' @param user_id	The encoded ID of the user. Use "-" (dash) for current logged-in user.
#' @export
get_favorite_activities <- function()
{
...
#' @export
add_favorite_activity <- function()
{
...
#' @param token An OAuth 2.0 token generated by oauth_token()
#' @param 'user-id	The encoded ID of the user. Use "-" (dash) for current logged-in user.
#' @param period	daily or weekly
#' @export
get_activity_goals <- function()
{
...
#' @param token An OAuth 2.0 token generated by oauth_token()
#' @export
update_activity_goals <- function()
{
